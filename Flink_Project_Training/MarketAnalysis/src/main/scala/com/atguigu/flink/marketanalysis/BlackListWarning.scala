...
object BlackListWarning {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val adEventStream = env.readTextFile("F:\\Flink\\Flink_Project_Training\\MarketAnalysis\\src\\main\\resources\\AdClickLog.csv")
      .map(data => {
    ...
    val adCountStream = filterBlackListStream
      ...
      .aggregate(new AdCountAgg(), new AdCountResent())
...
class AdCountResent() extends WindowFunction[Long,CountByProvince,String,TimeWindow]{
